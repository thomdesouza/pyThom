...
print('')
classificador = MLPClassifier(random_state=1, hidden_layer_sizes=(200, 100,),activation = "logistic") #random_state=1 keeps the seed
print('Classification Algorithm: MLP Neural Network')
...
prob = classificador.predict_proba(X_test) #pág. 397
# Compute precision / recall curve
pr , re , thresh = metrics.precision_recall_curve(y_test, prob[:, 0])
...
auc = metrics.roc_auc_score(y_test, prob[:, 0])
print('AUC:', auc)
# Plot ROC curve
